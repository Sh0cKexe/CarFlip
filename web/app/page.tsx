              ...
              <div className="bg-[#0e1621] px-3 py-4">
                ...
                <div className="max-w-[88%] rounded-2xl rounded-tl-sm bg-[#182533] px-3.5 py-2.5">
                  <div className="space-y-0.5 text-[13px] leading-relaxed">
                    ...
                    <p className="mt-6 text-zinc-300"><img src="https://flagcdn.com/h20/pl.png" alt="PL" className="mr-1 inline-block h-2.5 w-auto rounded-[2px] align-middle" />Cena: 9 900 PLN (≈ 56 370 Kč)</p>
                    <p className="text-zinc-300"><img src="https://flagcdn.com/h20/cz.png" alt="CZ" className="mr-1 inline-block h-2.5 w-auto rounded-[2px] align-middle" />Odhad prodej: 105 000 Kč</p>
