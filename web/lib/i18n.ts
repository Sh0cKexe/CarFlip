...
const CS = {
  ...
  navodPopis: "1. Otevři Telegram a napiš zprávu botovi @BotFather – příkazem /newbot vytvoříš vlastního bota a získáš Token bota.\n2. Napiš zprávu botovi @userinfobot – odešle ti tvoje Chat ID.\n3. Obě hodnoty vlož níže a klikni na Test spojení.",
...
const SK: typeof CS = {
  ...
  navodPopis: "1. Otvor Telegram a napíš správu botovi @BotFather – príkazom /newbot vytvoríš vlastného bota a získaš Token bota.\n2. Napíš správu botovi @userinfobot – odošle ti tvoje Chat ID.\n3. Obe hodnoty vlož nižšie a klikni na Test spojenia.",
