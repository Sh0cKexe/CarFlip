...
const CS = {
  ...
  cena: "Cena",
  aiInzeratPoznamky: "Co dalšího chceš v inzerátu zmínit (výbava, stav, důvod prodeje...)",
...
const SK: typeof CS = {
  ...
  rokVyroby: "Rok výroby",
  cena: "Cena",
  aiInzeratPoznamky: "Čo ďalšie chceš v inzeráte spomenúť (výbava, stav, dôvod predaja...)",
