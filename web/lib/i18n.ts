...
const CS = {
  ...
  botBadgeBezi: "Běží",
  botBadgeCeka: "Čeká na kontrolu",
  botBadgeProblem: "Problém",
  botBadgeVypnuto: "Vypnuto",
  trh: "Trh",
  trhCesko: "🇨🇿 Česko",
  ...
  prumernaDobaDrzeni: "Průměrná doba prodeje",
  dniZkratka: "dní",
  ...
  benzin: "benzín",
  diesel: "diesel",
  palivoFiltrHybrid: "hybrid (i plug-in)",
  palivoElektroKratce: "elektro",
  palivoLpgCng: "benzín+LPG/CNG",
  ...
  rokDo: "Rok do",
  karoserie: "Karoserie",
  karoserieKombi: "kombi",
  karoserieSedan: "sedan",
  karoserieHatchback: "hatchback",
  karoserieSuv: "SUV",
  karoserieKupe: "kupé",
  karoserieKabriolet: "kabriolet",
  karoserieVan: "van/dodávka",
  najezdNafta: "Nafta",
  najezdBenzinOstatni: "Benzín a ostatní pohony",
...
const SK: typeof CS = {
  ...
  botVypnuty: "Bot je vypnutý.",
  botBadgeBezi: "Beží",
  botBadgeCeka: "Čaká na kontrolu",
  botBadgeProblem: "Problém",
  botBadgeVypnuto: "Vypnuté",
  trh: "Trh",
  trhCesko: "🇨🇿 Česko",
  trhSlovensko: "🇸🇰 Slovensko",
  trhKratceCz: "CS-CZK",
  ...
  prumernaDobaDrzeni: "Priemerná doba predaja",
  dniZkratka: "dní",
  ...
  benzin: "benzín",
  diesel: "diesel",
  palivoFiltrHybrid: "hybrid (aj plug-in)",
  palivoElektroKratce: "elektro",
  palivoLpgCng: "benzín+LPG/CNG",
  ...
  karoserieVan: "van/dodávka",
  najezdNafta: "Nafta",
  najezdBenzinOstatni: "Benzín a ostatné pohony",
  cenaPlOd: "Cena PL od (PLN)",
  cenaPlDo: "Cena PL do (PLN)",
