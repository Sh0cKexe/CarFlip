...
const CS = {
  ...
  zdrojCesko: "🇨🇿 Česko (podhodnocené na Bazoši.cz)",
  zdrojSlovensko: "🇸🇰 Slovensko (podhodnocené na Bazoši.sk)",
...
const SK: typeof CS = {
  ...
  zdrojPolsko: "🇵🇱 Poľsko (import z Otomoto)",
  zdrojCesko: "🇨🇿 Česko (podhodnotené na Bazoši.cz)",
  zdrojSlovensko: "🇸🇰 Slovensko (podhodnotené na Bazoši.sk)",
  cenaCzOd: "Cena ČR od (Kč)",
  cenaCzDo: "Cena ČR do (Kč)",
  cenaSkOd: "Cena SK od (EUR)",
  cenaSkDo: "Cena SK do (EUR)",
